...
const tiers = [
  {
    ...
    href: '#',
    priceMonthly: '$60',
    description: "The perfect plan if you're needing just the basic features for the best price.",
    features: ['Free Phone for New Customers', 'Up to 6 Lines', 'Basic Data', 'Same Day Shipping'],
    featured: false,
  },
  {
    name: 'Ultimate',
    ...
    href: '#',
    priceMonthly: '$85',
    description: 'Better features with everything on Blue and the items listed below',
    features: [
      'Upgrade Every Year',
      '$5 Phone Protection',
      'Tesla Premium Connectivity',
      'Netflix and HBO Max On US',
      'Premium Data',
      'Up to 12 Lines',
    ],
    featured: true,
